...
class ContentUpgradeTest extends FreeSpec with Matchers {
  ...
  "rewrite body" - {
    ...
    "content capi object with contributor info NOT including cutout gets you a single upgraded object with imageCutoutReplace = false" in {
      val body =
        """
          |{"response":
          |  {"content":
    ...
    // This test will be wrong in the brave new world
    "content capi object results without contributor gets you a single upgraded object with imageCutoutReplace = false" in {
      val body =
        """
          |{"response":
          |  {"content":
