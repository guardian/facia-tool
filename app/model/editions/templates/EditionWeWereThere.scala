...
object EditionWeWereThere extends SpecialEdition {
  ...
  override val topic = "e-wwt"
   override val buttonImageUri = Some("https://i.guim.co.uk/img/media/375fb77684125af03b760bae24141f27da3b2f46/0_0_1000_2000/250.png?width=80&quality=85&s=808ddc9a72495aa5f2883be6ad69725d")  override val expiry: Option[String] = Some(
  ...
  override val buttonStyle: Option[SpecialEditionButtonStyles] = Some(
    SpecialEditionButtonStyles(
      ...
      title = EditionTextFormatting(color = "#007ABC", font="GHGuardianHeadline-Medium", lineHeight = 34, size = 32),
