...
---
flowchart TD;
    base["EnumEntry with HyphenCase"]--->Edition
    base--->FeastEdition
    Edition-->DailyEdition
    Edition-->AmericanEdition
    Edition-->AustralianEdition
    Edition-->moreEds["(Other Editions app publications)"]
    FeastEdition-->FeastNorthernHemisphere
    FeastEdition-->FeastSouthernHemisphere
```
