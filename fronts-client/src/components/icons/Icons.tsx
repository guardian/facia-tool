...
const VideoIcon = ({
	...
	>
		<path
			d="M0 3C0 1.34531 1.34531 0 3 0H15C16.6547 0 18 1.34531 18 3V15C18 16.6547 16.6547 18 15 18H3C1.34531 18 0 16.6547 0 15V3ZM26.2078 1.67813C26.6953 1.94063 27 2.44688 27 3V15C27 15.5531 26.6953 16.0594 26.2078 16.3219C25.7203 16.5844 25.1297 16.5562 24.6656 16.2469L20.1656 13.2469L19.5 12.8016V12V6V5.19844L20.1656 4.75312L24.6656 1.75313C25.125 1.44844 25.7156 1.41563 26.2078 1.67813Z"
			fill={fill}
		/>
	</svg>
);

const LoopIcon = ({ fill = theme.colors.blackDark, size = 'm' }: IconProps) => (
	<svg
		width={`${mapSize(size)}px`}
		height={`${mapSize(size)}px`}
		viewBox="0 0 22 22"
	...
	>
		<path
			...
			fill={fill}
		/>
		<path d="M9 14V8L15 11L9 14Z" fill={fill} />
	</svg>
);

const CinemagraphIcon = ({
	fill = theme.colors.blackDark,
	size = 's',
}: IconProps) => (
	<svg
	...
	>
		<path
			d="M0 3C0 1.34531 1.34531 0 3 0H21C22.6547 0 24 1.34531 24 3V18C24 19.6547 22.6547 21 21 21H3C1.34531 21 0 19.6547 0 18V3ZM2.25 15.75V17.25C2.25 17.6625 2.5875 18 3 18H4.5C4.9125 18 5.25 17.6625 5.25 17.25V15.75C5.25 15.3375 4.9125 15 4.5 15H3C2.5875 15 2.25 15.3375 2.25 15.75ZM19.5 15C19.0875 15 18.75 15.3375 18.75 15.75V17.25C18.75 17.6625 19.0875 18 19.5 18H21C21.4125 18 21.75 17.6625 21.75 17.25V15.75C21.75 15.3375 21.4125 15 21 15H19.5ZM2.25 9.75V11.25C2.25 11.6625 2.5875 12 3 12H4.5C4.9125 12 5.25 11.6625 5.25 11.25V9.75C5.25 9.3375 4.9125 9 4.5 9H3C2.5875 9 2.25 9.3375 2.25 9.75ZM19.5 9C19.0875 9 18.75 9.3375 18.75 9.75V11.25C18.75 11.6625 19.0875 12 19.5 12H21C21.4125 12 21.75 11.6625 21.75 11.25V9.75C21.75 9.3375 21.4125 9 21 9H19.5ZM2.25 3.75V5.25C2.25 5.6625 2.5875 6 3 6H4.5C4.9125 6 5.25 5.6625 5.25 5.25V3.75C5.25 3.3375 4.9125 3 4.5 3H3C2.5875 3 2.25 3.3375 2.25 3.75ZM19.5 3C19.0875 3 18.75 3.3375 18.75 3.75V5.25C18.75 5.6625 19.0875 6 19.5 6H21C21.4125 6 21.75 5.6625 21.75 5.25V3.75C21.75 3.3375 21.4125 3 21 3H19.5ZM7.5 4.5V7.5C7.5 8.32969 8.17031 9 9 9H15C15.8297 9 16.5 8.32969 16.5 7.5V4.5C16.5 3.67031 15.8297 3 15 3H9C8.17031 3 7.5 3.67031 7.5 4.5ZM9 12C8.17031 12 7.5 12.6703 7.5 13.5V16.5C7.5 17.3297 8.17031 18 9 18H15C15.8297 18 16.5 17.3297 16.5 16.5V13.5C16.5 12.6703 15.8297 12 15 12H9Z"
			fill={fill}
		/>
	</svg>
);

const ConicalFlaskIcon = ({
	fill = theme.colors.blackDark,
	size = 's',
}: IconProps) => (
	<svg
	...
	>
		<path
			d="M10.3571 0H6.64286H5.71429C5.20067 0 4.78571 0.474804 4.78571 1.0625C4.78571 1.65019 5.20067 2.125 5.71429 2.125V6.53438C5.71429 6.92617 5.61853 7.31465 5.43861 7.64668L2.29888 13.4871C2.10446 13.8524 2 14.2674 2 14.6956C2 15.9674 2.90246 17 4.01384 17H12.9862C14.0975 17 15 15.9674 15 14.6956C15 14.2706 14.8955 13.8524 14.7011 13.4871L11.5614 7.65C11.3815 7.31465 11.2857 6.9295 11.2857 6.53769V2.125C11.7993 2.125 12.2143 1.65019 12.2143 1.0625C12.2143 0.474804 11.7993 0 11.2857 0H10.3571ZM7.57143 6.53438V2.125H9.42857V6.53438C9.42857 7.32129 9.62009 8.0916 9.97991 8.76231L10.981 10.625H6.01897L7.02009 8.76231C7.37991 8.0916 7.57143 7.32129 7.57143 6.53438Z"
			fill={fill}
		/>
	</svg>
);
...
const ConicalFlaskCircleIcon = ({
	...
	>
		<path
			d="M7.5 0C11.6421 0 15 3.35786 15 7.5C15 11.6421 11.6421 15 7.5 15C3.35786 15 0 11.6421 0 7.5C0 3.35786 3.35786 0 7.5 0ZM5.72754 2.72754C5.4007 2.72754 5.13672 2.99423 5.13672 3.32422C5.13691 3.65404 5.40081 3.9209 5.72754 3.9209V6.39648C5.72751 6.61633 5.66613 6.83417 5.55176 7.02051L3.55371 10.2998C3.43005 10.5048 3.36334 10.7382 3.36328 10.9785C3.36328 11.6926 3.93827 12.2725 4.64551 12.2725H10.3545C11.0617 12.2725 11.6367 11.6926 11.6367 10.9785C11.6367 10.74 11.5699 10.5048 11.4463 10.2998L9.44824 7.02246C9.33386 6.83427 9.27251 6.61828 9.27246 6.39844V3.9209C9.59919 3.9209 9.86309 3.65404 9.86328 3.32422C9.86328 2.99423 9.5993 2.72754 9.27246 2.72754H5.72754ZM8.09082 6.39648C8.09085 6.83826 8.21248 7.27092 8.44141 7.64746L9.0791 8.69336H5.9209L6.55859 7.64746C6.78752 7.27092 6.90915 6.83826 6.90918 6.39648V3.9209H8.09082V6.39648Z"
			fill={fill}
		/>
	</svg>
);
