...
const CogIcon = ({ fill = '#333', size = 'm' }: IconProps) => (
	<svg
		width={mapSize(size)}
		height={mapSize(size)}
		viewBox="0 0 24 24"
	...
	>
		<path
			fill={fill}
			d="M12 15.5A3.5 3.5 0 0 1 8.5 12 3.5 3.5 0 0 1 12 8.5a3.5 3.5 0 0 1 3.5 3.5 3.5 3.5 0 0 1-3.5 3.5m7.43-2.92c.04-.33.07-.67.07-1.08s-.03-.75-.07-1.08l2.32-1.82c.21-.16.27-.46.13-.71l-2.2-3.82c-.13-.25-.42-.33-.67-.25l-2.73 1.1c-.57-.44-1.18-.79-1.85-1.05L14.17 2c-.05-.27-.27-.5-.57-.5H10.4c-.3 0-.52.23-.57.5l-.41 2.87c-.67.26-1.28.6-1.85 1.05L4.84 6.34c-.25-.08-.54 0-.67.25L1.97 10.41c-.14.25-.08.55.13.71l2.32 1.82C4.38 13.25 4.35 13.59 4.35 14s.03.75.07 1.08L2.1 16.9c-.21.16-.27.46-.13.71l2.2 3.82c.13.25.42.33.67.25l2.73-1.1c.57.44 1.18.79 1.85 1.05l.41 2.87c.05.27.27.5.57.5h4.4c.3 0 .52-.23.57-.5l.41-2.87c.67-.26 1.28-.6 1.85-1.05l2.73 1.1c.25.08.54 0 .67-.25l2.2-3.82c.14-.25.08-.55-.13-.71l-2.32-1.82z"
		/>
	</svg>
);
