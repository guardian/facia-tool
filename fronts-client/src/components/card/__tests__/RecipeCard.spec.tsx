...
const recipeFixture = {
  ...
  "canonicalArticle": "lifeandstyle/2017/feb/19/ofm-classic-cookbook-claudia-roden-book-of-middle-eastern-food",
  ...
  "instructions": [
    {
      "stepNumber": 0,
      "description": "Moisten the couscous slightly with a little cold water, working it in with the fingers to prevent lumps from forming.",
      "images": []
    },
    {
      "stepNumber": 1,
    ...
    {
      "stepNumber": 2,
      "description": "Rake the grains with your fingers to air them and help them to swell better.",
      "images": []
    },
    {
      "stepNumber": 3,
    ...
    {
      "stepNumber": 6,
      "description": "Sprinkle generously with cold water and stir well with a wooden spoon to break up any lumps and to separate and air the grains.",
      "images": []
    },
    {
      "stepNumber": 7,
    ...
    {
      "stepNumber": 9,
      "description": "(A tablespoon of oil is sometimes added at the same time) Return to the top container and steam for a further 30 minutes.",
      "images": []
    },
    {
      "stepNumber": 10,
    ...
    {
      "stepNumber": 11,
      "description": "Boil the fish tails and heads with all the vegetables, salt, black and cayenne pepper and saffron in 1-1½ litres water.",
      "images": []
    },
    {
      "stepNumber": 12,
    ...
    {
      "stepNumber": 13,
      "description": "Simmer for an hour until the stock is rich and the vegetables are soft.",
      "images": []
    },
    {
      "stepNumber": 14,
    ...
    {
      "stepNumber": 15,
      "description": "Put it in the sieve and steam it over the simmering fish stock for 30 minutes.",
      "images": []
    },
    {
      "stepNumber": 16,
    ...
    {
      "stepNumber": 17,
      "description": "Remove the fish tails and heads from the stock, and if you like strain through a fine sieve, then return the vegetables to the stock.",
      "images": []
    },
    {
      "stepNumber": 18,
    ...
    {
      "stepNumber": 20,
      "description": "Return the couscous to the sieve and steam it over the simmering fish for a further 30 minutes, less if the pieces of fish are not large.",
      "images": []
    },
    {
      "stepNumber": 21,
    ...
    {
      "stepNumber": 22,
      "description": "Serve the fish and its sauce over the couscous in a large dish, or in separate dishes.",
      "images": []
    }
  ],
  "previewImage": {
...
describe('RecipeCard', () => {
  ...
  it('should render a warning state if the recipe is not defined', async () => {
    ...
    const headline = await component.findAllByTestId("headline");
    expect(headline).toHaveLength(1);
    expect(headline[0].textContent).toEqual("This recipe won’t load in the app, please select an alternative.");
